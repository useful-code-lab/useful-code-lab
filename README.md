...
<details>
  <summary>Можно отправить донат если хотите, который поможет мне добавить ещё подобное очень прикольное. У меня подобных приколов ещё больше было если честно</summary>
