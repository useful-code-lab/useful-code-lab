...
Курсы, которые я создал с помощью AI-искусственного интеллекта на STEPIK с помощью генерации из Open AI по специально разработанным мною скриптам и полной автоматизацией выгрузки в STEPIK, где еще использовалось кэширование, мой собственный веб-сервис на flask, дублирующий STEPIK-интерфейс по REST. Основной паттерн конкурентной обработки по REST, а курсов очень много, был асинхронный паттерн "Семафор" на Python. В процессе провел исследование API Stepik, которое не документировано:
...
[Квест-курс: Успех, деньги и уют — пошаговая стратегия](https://stepik.org/course/261754/promo), 
[Специалист по Data Science и ML в обучающих мирах Minecraft](https://stepik.org/course/262586/promo), 
[Профилирование и оптимизация: Программы на Python и Go](https://stepik.org/course/262583/promo), 
[DevOps-Археология: находки в глубинах CI/CD (уровень Pro)](https://stepik.org/course/255400/promo), 
[Продвинутый курс улучшения решений](https://stepik.org/course/263363/promo), 
...
[Командные приключения программистов — прокачка Soft Skils](https://stepik.org/course/262582/promo), 
[Сборник 40 вопросников "Путеводитель по миру кошек"](https://stepik.org/course/258659/promo), 
...
<details>
  <summary>Можно отправить донат если хотите, который поможет мне добавить ещё подобное очень прикольное. У меня подобных приколов ещё больше было если честно. У меня еще был логотип Laravel, Node.js из SVG (Scalable Vector Graphics) , и др., по которому бегал шарик по всему логотипу, прикольно было наблюдать за анимацией и это дало мне понимание устройства SVG вплоть до каждой точки и линии. Тоже полезное занятие</summary>
