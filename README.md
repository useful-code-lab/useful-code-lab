...
Бесплатные курсы, которые я создал с помощью AI-искусственного интеллекта на STEPIK с помощью генерации из Open AI по специально разработанным мною скриптам и полной автоматизацией выгрузки в STEPIK, где еще использовалось кэширование, мой собственный веб-сервис, дублирующий STEPIK-интерфейс по REST. Основной паттерн конкурентной обработки по REST, а курсов очень много, был паттерн "Семафор":
