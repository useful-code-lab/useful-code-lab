...
<details>
  <summary>Можно отправить донат если хотите, который поможет мне добавить ещё подобное очень прикольное. У меня подобных приколов ещё больше было если честно. У меня еще был логотип Laravel, Node.js и др из SVG (Scalable Vector Graphics), по которому бегал шарик по всему логотипу, прикольно было наблюдать за анимацией и это дало мне понимание устройства SVG вплоть до каждой точки и линии.</summary>
